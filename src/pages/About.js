...
export default function About(props) {
    ...
    <div className="about">
        ...
        <section className='pic-bottom'>
            ...
            <div className='text'>
                <p>That’s why our twist on a traditional treat is made with dye-free, all-natural flavors blended into a base of organic sugar that is guaranteed to bring back as many memories as it will create new ones.</p>
            </div>
        </section>
    </div>
    )
